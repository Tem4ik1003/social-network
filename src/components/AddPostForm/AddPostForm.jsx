...
import {addNewPostAC} from "../../redux/userReducer";
...
const AddPostForm = () => {
    ...
    const onAddPost = () => {
        dispatch(addNewPostAC(textPost))
    }

    return (
        <div className={styles.formAddPost}>
            <div>
                                    <textarea cols="30" rows="10" value={textPost} onChange={onChangeText}
                ...
                <div className={styles.buttons}>
                    ...
                    <div className="button__send">
                        <Button onClick={onAddPost}>Опублікувати</Button>
                    </div>
                </div>
            </div>
        </div>
